          ...
          @dictionary_sizes.each do |dic_size|
            @selectors.each do |selector|
              ...
              @trainers.each do |trainer|
                l "#{{classification: classification, trainer: trainer.label, selector: selector.class.to_s, preprocessor: @preprocessor.class.to_s, dictionary_size: dic_size, samplesize: samplesize}}"
